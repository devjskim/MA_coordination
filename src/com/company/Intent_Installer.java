...
public class Intent_Installer {
    ...
    public String[] Selection_list_iterator(List<Resource_info.Selection_Info> Selection_list,int i){
        String[] input = new String[2];

        input[0] = Cloud_Host_MAC+"/None";
        input[1] = Selection_list.get(i).Host_ID+"/None";
